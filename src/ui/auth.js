  ...
  const bootstrapDocs = (ctx = {}) => {
    ...
    const ensureHeader = (root) => {
      ...
      <div class="warest-logo">
        <img class="warest-logo-img" src="${baseUrl}/media/warest.png" alt="Sengar Infotech Logo" />
        <div class="warest-logo-text">
          <strong style="color:black;">Sengar Infotech - WhatsApp Rest API Multi Sessions</strong>
    ...
    const ensureFooter = (root) => {
      ...
      footer.innerHTML = `&copy; ${year} Sengar Infotech. All rights reserved.`;
    ...
    const injectCodeTable = () => {
      ...
      section.innerHTML = `
      <h2>Sengar Infotech API Code Reference</h2>
